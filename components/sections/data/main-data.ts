export const quinceMainData = {
  ...
  event: {
    ...
    godparents: {
      godfather: "Martín Romero Macías",
  ...
  timeline: {
    ...
    events: [
      ...
      },
      {
        id: "event3",
        time: "19:30 hrs.",
        title: "Entrada de la Quinceañera y Brindis",
      ...
      },
      {
        ...
        description: "Corte del pastel y momento dulce.",
        icon: "🎂",
      },
      {
        id: "event7",
        ...
        description: "Música y baile para todos los invitados.",
        icon: "🎶",
      }
    ],
  },
